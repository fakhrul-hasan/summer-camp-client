...
const Classes = () => {
    ...
    return (
        ...
        <div className="space-y-4">
          ...
          <p className='w-1/2 space-y-2'>Lorem ipsum dolor, amet consectetur adipisicing elit. Minus totam, minima error quibusdam voluptates rerum et, velit, asperiores ipsam numquam? Deleniti odio!</p>
        </div>
      </div>
